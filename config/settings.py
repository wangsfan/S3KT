...
class Settings:
    def __init__(self, settings_yaml, generate_log=True):
        ...
        with open(settings_yaml, 'r') as stream:
            ...
            self.path_to_model = '/home/thc/ess/e2vid/E2VID_lightweight.pth.tar'
            ...
            if self.dataset_name_a in ['EventScape_rgb', 'EventScape_gray', 'EventScape_recurrent_gray',
                                       'EventScape_recurrent_rgb','Cityscapes_gray', 'DDD17_gray', 'DDD17_Cityscapes_gray', 'kitti']:
                self.input_channels_a = 1
                if self.dataset_name_a in ['Cityscapes_gray', 'DDD17_Cityscapes_gray', 'kitti']:
            ...
            if self.dataset_name_b in ['EventScape_recurrent_events', 'DSEC_events', 'DDD17_events', 'E2VIDDriving_events', 'MVSEC_events']:
                if self.dataset_name_b == 'MVSEC_events':
